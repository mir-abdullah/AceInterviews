      ...
      >
        <div className="text-center">
          <h2 className="lg:text-5xl text-3xl text-neutralBlack font-semibold mb-6 lg:leading-snug">
            Elevate Your Interview Skills with AceInterview
          </h2>
          <p className="text-neutralGrey text-base mb-8">
            Experience a breakthrough in interview preparation with our
            tailored, real-time simulation platform. Get started today and
