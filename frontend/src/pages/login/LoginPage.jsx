          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                disabled={loading}
                type="submit"
                className={`w-full py-3 bg-green-600 text-white font-semibold rounded-lg shadow-md hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-purple-400 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
