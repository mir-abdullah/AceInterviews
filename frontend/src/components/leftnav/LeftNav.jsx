    ...
    {routes.map((route, index) => {
        ...
        return (
          <div key={index} className="flex flex-col">
            <button
              ...
              className={`flex items-center justify-between gap-4 p-4 border-r-4 transition-colors duration-200 ease-in-out text-lg font-semibold ${ // Increased text size and weight
                isInterviewOpen
      ...
      return (
        <NavLink
          ...
          to={route.path}
          className={({ isActive }) =>
            `flex items-center gap-4 p-4 border-r-4 transition-colors duration-200 ease-in-out text-lg font-semibold ${ // Increased text size and weight
              isActive
                ? "bg-green-700 border-green-300"
                : "border-transparent hover:border-green-300 hover:bg-green-700"
            }`
